public class MainApp {
    public static void main(String[] args) {
        ...
        Consulta consulta = new Consulta("2025-10-16", "16:20h", EPrioridade.BAIXA, "teste2");
        Consulta consulta1 = new Consulta("2025-10-29", "15:20", EPrioridade.ALTA, "teste");
        ...
        Medicamento medicamento = new Medicamento("Clonazepam", "UBS");
        Medicamento medicamento1 = new Medicamento("Atorvastatina Caucica", "Unimed");
        Medicamento medicamento2 = new Medicamento("Dorflex", "Cimed");
        Medicamento medicamento3 = new Medicamento("Dipirona", "ANS");

        RegistroConsulta rg1 = new RegistroConsulta("Consulta com um ortopedista");
        RegistroConsulta rg2  = new RegistroConsulta("Consulta com um cardiologista");

        HistoricoMedicacao hm1 = new HistoricoMedicacao(rg1, medicamento, "teste");
